...
let AssetContract = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = initialize(), _dec3 = call({}), _dec4 = call({}), _dec5 = view(), _dec6 = view(), _dec7 = call({}), _dec8 = call({}), _dec9 = call({}), _dec(_class = (_class2 = class AssetContract {
  assetPrice = "";
  escrowContractId = "";
  totalSupply = "0";
  ...
  accountAssetsItem = "";
  mainOwnerId = "";
  pendingAccountAssets = new LookupMap("paa");
  init({
    owner_id,
    total_supply,
    escrow_contract_id,
  ...
  escrow_purchase_asset({
    ...
    try {
      assert(predecessorAccountId() === this.escrowContractId, `Only escrow contract can call this method but called by ${predecessorAccountId()}`);
      ...
      const sellerAssets = BigInt(this.accountAssetsQuantity.get(seller_account_id));

      // Deduct the quantity from the seller's assets
      const sellerNewAssets = sellerAssets - quantity;
      ...
      if (sellerNewAssets <= BigInt(0)) {
        ...
        const receivingAccountNewAssets = this.accountAssetsQuantity.containsKey(buyer_account_id) ? BigInt(this.accountAssetsQuantity.get(buyer_account_id)) + sellerAssets : sellerAssets;
        ...
        const receivingAccountNewAssets = this.accountAssetsQuantity.containsKey(buyer_account_id) ? BigInt(this.accountAssetsQuantity.get(buyer_account_id)) + quantity : quantity;
        this.accountAssetsQuantity.set(buyer_account_id, receivingAccountNewAssets.toString());
      }
      log("success: ", seller_account_id, buyer_account_id, quantity.toString(), attached_near, this.assetPrice, this.accountAssetsQuantity.get(buyer_account_id));
      return {
        success: true,
        seller_account_id,
        buyer_account_id,
        quantity: quantity.toString(),
        amount: attached_near,
        asset_account_id: currentAccountId()
      };
    } catch (e) {
      log("error: ", e, e.message, e.stack);
      return {
        success: false,
        error: e,
        message: e.message,
  ...
  transfer_asset({
    ...
    const senderAssets = BigInt(this.accountAssetsQuantity.get(from_account_id));
    ...
    if (this.accountAssetsQuantity.containsKey(receivingAccountId)) {
      const receivingAccountAssets = BigInt(this.accountAssetsQuantity.get(receivingAccountId));
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_asset_item", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_asset_item"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "escrow_purchase_asset", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "escrow_purchase_asset"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_total_supply", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_total_supply"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_account_assets", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "get_account_assets"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "validate_asset", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "validate_asset"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "devalidate_asset", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "devalidate_asset"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "transfer_asset", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "transfer_asset"), _class2.prototype)), _class2)) || _class);
function transfer_asset() {
  const _state = AssetContract._getState();
  if (!_state && AssetContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = AssetContract._create();
  if (_state) {
    AssetContract._reconstruct(_contract, _state);
  }
  const _args = AssetContract._getArgs();
  const _result = _contract.transfer_asset(_args);
  AssetContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetContract._serialize(_result, true));
}
function devalidate_asset() {
  const _state = AssetContract._getState();
  if (!_state && AssetContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AssetContract._getArgs();
  const _result = _contract.devalidate_asset(_args);
  AssetContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetContract._serialize(_result, true));
}
function validate_asset() {
  ...
  const _args = AssetContract._getArgs();
  const _result = _contract.validate_asset(_args);
  AssetContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetContract._serialize(_result, true));
}
function get_account_assets() {
  const _state = AssetContract._getState();
  if (!_state && AssetContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AssetContract._getArgs();
  const _result = _contract.get_account_assets(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetContract._serialize(_result, true));
}
...
function escrow_purchase_asset() {
  const _state = AssetContract._getState();
  if (!_state && AssetContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AssetContract._getArgs();
  const _result = _contract.escrow_purchase_asset(_args);
  AssetContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetContract._serialize(_result, true));
}
function get_asset_item() {
  const _state = AssetContract._getState();
  if (!_state && AssetContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AssetContract._getArgs();
  const _result = _contract.get_asset_item(_args);
  AssetContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetContract._serialize(_result, true));
}
function init() {
...
export { AssetContract, devalidate_asset, escrow_purchase_asset, get_account_assets, get_asset_item, get_total_supply, init, transfer_asset, validate_asset };
//# sourceMappingURL=assets_near.js.map
